...
public:
    GoalNavigator() : Node("goal_navigator")
    {
        ...
        if (!readGoalFromFile("/home/min/alsong_ws/src/pill_navigation/config/destination.txt", target_pose_))
        {
...
private:
    ...
    {
        std::ifstream file("/home/min/alsong_ws/src/pill_navigation/config/destination.txt");
        if (!file.is_open())
        {
